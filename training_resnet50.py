...
from utils import k_fold_splitter, create_training_data, aug_rot, aug_crop, aug_cutout, aug_shear, aug_gblur, aug_randcomb, train_model_resnet50, read_args, aug_mobius, shift_func, mobius_fast_interpolation, getabcd_1fix, M_admissable, madmissable_abcd
...
for i in range(0, len(training_list)):
    ...
    valaccs.append(train_model_resnet50(training_list[i], val_list[i], savename + '{}'.format(i)))
