...
from utils import k_fold_splitter, create_training_data, aug_rot, aug_crop, aug_cutout, aug_shear, aug_g_blur, \
    aug_rand_comb, train_model_resnet50, read_args, aug_mobius, shift_func, mobius_fast_interpolation, getabcd_1fix, \
...
for i in range(0, len(training_list)):
    ...
    val_accs.append(train_model_resnet50(training_list[i], val_list[i], save_name + '{}'.format(i)))
