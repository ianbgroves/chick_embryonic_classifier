...
path = os.getcwd()
DATADIR = path+'/labeled_data_all_stages_w_test_held_back'
...
for i in range(0, len(training_list)):
    ...
    valaccs.append(train_model_limb(training_list[i], val_list[i], savename + '{}'.format(i)))
